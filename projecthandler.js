...
function normalizeStatus(status) {
  ...
  // Handle version releases (v1 released, v2 released, etc.)
  if (statusLower.includes("released")) {
    return "released";
  }
  ...
  // Default: return the original status lowercased
  ...
  return `
        <div class="project-card" data-project-id="${project.id}">
            ...
            <div class="project-meta">
                ...
                <span class="status ${normalizeStatus(project.status)}">${
    project.status
  }</span>
            </div>
            <p class="description">${
              isDetailedView ? project.content : project.description
            }</p>
            ...
            <div class="project-links">
                ${
                  project.githubUrl
                    ...
                    : `<span class="link-unavailable github-unavailable" title="This repository is private or not yet public">
                ...
                ${
                  project.liveUrl
                    ...
                    : `<span class="link-unavailable demo-unavailable" title="Project is still in development">
...
export { fetchProjectData, updateLatestProjects, loadProjects, loadProject };
